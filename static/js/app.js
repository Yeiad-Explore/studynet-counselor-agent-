...
class RAGAgent {
  ...
  bindEvents() {
    ...
    // System controls
    this.elements.refreshStatus?.addEventListener("click", () => this.loadSystemStatus());
  }
  ...
  async loadSystemStatus() {
    try {
      ...
      if (sessionsResponse.ok) {
        ...
        this.elements.sessionCount.textContent = sessionsData.count || 0;
        this.systemStatus.sessions = sessionsData.count || 0;
      } else {
        this.elements.sessionCount.textContent = "-";
        this.systemStatus.sessions = 0;
      }
    } catch (error) {
